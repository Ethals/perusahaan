                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="input-group">
                            ...
                            <input class="form-control py-4" name="username" id="username" type="text" value="admin" placeholder="Enter username" value="<?= set_value('username') ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="input-group" id="show_hide_password">
                            ...
                            <input class="form-control py-4" name="password" id="password" type="password" value="12345678" placeholder="Enter password" />
